...
set "FFMPEG_DIR=%PROJECT_ROOT%\third_party\ffmpeg_install\windows\x86_64"
set "LIBHEIF_DIR=%PROJECT_ROOT%\third_party\libheif_install\windows\x86_64"
set "OPENH264_DIR=%PROJECT_ROOT%\third_party\openh264_install\windows\x86_64"
