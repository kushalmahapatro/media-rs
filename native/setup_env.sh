...
export FFMPEG_DIR="$PROJECT_ROOT/third_party/generated/ffmpeg_install"
export LIBHEIF_DIR="$PROJECT_ROOT/third_party/generated/libheif_install/macos/universal"

# Detect architecture for OpenH264
ARCH=$(uname -m)
OPENH264_BUILD_DIR="$PROJECT_ROOT/third_party/generated/openh264_build_$ARCH"
...
LIBHEIF_PKG_CONFIG="$PROJECT_ROOT/third_party/generated/libheif_install/macos/universal/lib/pkgconfig"
FFMPEG_PKG_CONFIG="$PROJECT_ROOT/third_party/generated/ffmpeg_install/lib/pkgconfig"
