...
- **OpenH264**: BSD-2-Clause license (LGPL-compatible, includes patent coverage from Cisco for binary distributions)
- **MediaCodec**: Disabled by default - use OpenH264 for H.264 encoding (MediaCodec can be enabled if needed, but OpenH264 provides clearer licensing)
