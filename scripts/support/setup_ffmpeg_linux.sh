...
INSTALL_DIR="$GENERATED_DIR/ffmpeg_install/linux/$ABI_DIR"
BUILD_DIR="$GENERATED_DIR/ffmpeg_build_linux_$ABI_DIR"

OPENH264_DIR="$GENERATED_DIR/openh264_install/linux/$ABI_DIR"
