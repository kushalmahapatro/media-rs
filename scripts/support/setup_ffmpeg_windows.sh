...
INSTALL_DIR="$GENERATED_DIR/ffmpeg_install/windows/$ABI_DIR"
BUILD_DIR="$GENERATED_DIR/ffmpeg_build_windows_$ABI_DIR"

OPENH264_DIR="$GENERATED_DIR/openh264_install/windows/$ABI_DIR"
