...
impl Audio {
    ...
    pub fn channels(&self) -> u16 {
        #[cfg(all(not(feature = "ffmpeg_7_0"), not(ffmpeg_8_0)))]
        unsafe {
            (*self.as_ptr()).channels as u16
        }

        #[cfg(any(feature = "ffmpeg_7_0", ffmpeg_8_0))]
        {
    ...
    pub fn channel_layout(&self) -> ChannelLayout {
        ...
        #[cfg(any(feature = "ffmpeg_7_0", ffmpeg_8_0))]
        unsafe {
            ChannelLayout((*self.as_ptr()).ch_layout)
        }
    }
    ...
    pub fn set_channel_layout(&mut self, value: ChannelLayout) {
        unsafe {
            ...
            #[cfg(any(feature = "ffmpeg_7_0", ffmpeg_8_0))]
            {
                (*self.as_mut_ptr()).ch_layout = value.0;
            }
        }
    }
