...
#[cfg(all(feature = "codec", not(feature = "ffmpeg_5_0"), not(ffmpeg_8_0)))]
...
#[cfg(all(feature = "format", not(feature = "ffmpeg_5_0"), not(ffmpeg_8_0)))]
fn init_format() {
    format::register_all();
}

#[cfg(any(not(feature = "format"), feature = "ffmpeg_5_0", ffmpeg_8_0))]
fn init_format() {}
