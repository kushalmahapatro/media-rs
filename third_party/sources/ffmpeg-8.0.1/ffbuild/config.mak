...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/mkus7697/Projects/KATIM/media-rs/third_party/ffmpeg_build_x86_64 --pkg-config-flags=--static --enable-static --disable-shared --disable-programs --disable-doc --enable-swscale --enable-avcodec --enable-avformat --enable-avutil --enable-videotoolbox --enable-zlib --disable-avdevice --disable-avfilter --disable-debug --disable-ffplay --disable-ffprobe --disable-gpl --disable-nonfree --arch=x86_64 --cc='clang -arch x86_64' --disable-x86asm --enable-cross-compile
...
CC_IDENT=Homebrew clang version 21.1.3
ARCH=x86
INTRINSICS=sse2
EXTERN_PREFIX=_
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=-I/opt/homebrew/opt/llvm/include -D_ISOC11_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -I$(SRC_PATH)/compat/dispatch_semaphore -DPIC -I$(SRC_PATH)/compat/stdbit -DZLIB_CONST
CFLAGS=   -std=c17 -Werror=partial-availability -fno-common -fomit-frame-pointer -fPIC -pthread -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Wno-implicit-const-int-float-conversion -Wno-microsoft-enum-forward-reference -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS=-L/opt/homebrew/opt/llvm/lib/unwind -lunwind  -Wl,-dynamic,-search_paths_first -Wl,-no_warn_duplicate_libraries -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avutil=-lm -framework VideoToolbox -pthread -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
EXTRALIBS-ffplay=
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
