...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/d/media-rs/media-rs/third_party/ffmpeg_build_windows_x86_64 --pkg-config-flags=--static --pkg-config=pkg-config --enable-static --disable-shared --disable-programs --disable-doc --enable-avcodec --enable-avformat --enable-avutil --enable-swscale --enable-swresample --enable-zlib --disable-avdevice --disable-avfilter --disable-debug --disable-ffplay --disable-ffprobe --disable-gpl --disable-nonfree --arch=x86_64 --target-os=mingw32 --cc=x86_64-w64-mingw32-gcc --enable-libopenh264 --enable-encoder=libopenh264 --enable-decoder=libopenh264 --extra-cflags=-I/d/media-rs/media-rs/third_party/openh264_install/windows/x86_64/include --extra-ldflags='-L/d/media-rs/media-rs/third_party/openh264_install/windows/x86_64/lib -static-libgcc -static-libstdc++' --extra-libs='-lopenh264 -lstdc++'
...
CC_IDENT=gcc 15.2.0 (Rev9, Built by MSYS2 project)
ARCH=x86
INTRINSICS=sse2
EXTERN_PREFIX=
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC11_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DWIN32_LEAN_AND_MEAN -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__ -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC -I$(SRC_PATH)/compat/stdbit -DZLIB_CONST
CFLAGS=  -I/d/media-rs/media-rs/third_party/openh264_install/windows/x86_64/include -std=c17 -fomit-frame-pointer -ID:/media-rs/media-rs/third_party/openh264_install/windows/x86_64/include -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/d/media-rs/media-rs/third_party/openh264_install/windows/x86_64/include
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -L/d/media-rs/media-rs/third_party/openh264_install/windows/x86_64/lib -static-libgcc -static-libstdc++  -Wl,--nxcompat,--dynamicbase -Wl,--high-entropy-va -Wl,--as-needed -Wl,-rpath-link=:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
...
HOSTLD=x86_64-w64-mingw32-gcc
HOSTCFLAGS=  -std=c17 -Wall -O3
HOSTCPPFLAGS= -D_ISOC11_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__ -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600
HOSTEXESUF=.exe
HOSTLDFLAGS= 
HOSTEXTRALIBS=-lm
DEPHOSTCC=x86_64-w64-mingw32-gcc
...
EXTRALIBS-avformat=-lm -latomic -lbz2 -lz -lsecur32 -lncrypt -lcrypt32 -lws2_32
EXTRALIBS-avcodec=-liconv -lm -latomic -llzma -LD:/media-rs/media-rs/third_party/openh264_install/windows/x86_64/lib -lopenh264 -lmfuuid -lole32 -lstrmiids -lole32 -luser32 -lz
