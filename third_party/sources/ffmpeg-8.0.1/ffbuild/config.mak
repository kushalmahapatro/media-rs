...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/kushal/project/media-rs/third_party/ffmpeg_build_linux_x86_64 --pkg-config-flags=--static --pkg-config=pkg-config --enable-static --disable-shared --disable-programs --disable-doc --enable-avcodec --enable-avformat --enable-avutil --enable-swscale --enable-swresample --enable-zlib --disable-avdevice --disable-avfilter --disable-debug --disable-ffplay --disable-ffprobe --disable-gpl --disable-nonfree --arch=x86_64 --enable-libopenh264 --enable-encoder=libopenh264 --enable-decoder=libopenh264 --extra-cflags=-I/home/kushal/project/media-rs/third_party/openh264_install/linux/x86_64/include --extra-ldflags=-L/home/kushal/project/media-rs/third_party/openh264_install/linux/x86_64/lib --extra-libs='-lm -lpthread'
...
CFLAGS=  -I/home/kushal/project/media-rs/third_party/openh264_install/linux/x86_64/include -std=c17 -fomit-frame-pointer -fPIC   -pthread  -I/home/kushal/project/media-rs/third_party/openh264_install/linux/x86_64/include   -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/home/kushal/project/media-rs/third_party/openh264_install/linux/x86_64/include -fPIC
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -L/home/kushal/project/media-rs/third_party/openh264_install/linux/x86_64/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,-rpath-link=:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -lm -latomic -L/home/kushal/project/media-rs/third_party/openh264_install/linux/x86_64/lib -lopenh264 -lstdc++ -lz
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-lm -latomic -pthread -lX11 -lpthread -lxcb -lXau -lXdmcp
EXTRALIBS-ffplay=
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
